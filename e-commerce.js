...
products.set("Drinks", [["Pepsi", 500, 1], ["Coke", 500, 1], ["Fanta", 500, 1], ["Yougurt", 700, 1]]);
products.set("Food", [["Rice", 2000, 1], ["Swallow", 5000, 1], ["Pie", 7000, 1],["bread", 1200, 1]]);
products.set("Furniture", [["Table", 15000, 1], ["Tv", 50000, 1], ["Chair", 8000, 1], ["Bed", 17000, 1]]);
products.set("Cosmetics", [["Cream", 6000, 1], ["Scrub", 3000, 1], ["Perfume", 4000, 1], ["Powder", 2000, 1]]);
products.set("Clothes", [["Trouser", 7500, 1], ["Shirts", 5000, 1], ["Shoes", 20000, 1], ["Bracelets", 2500, 1]]);
products.set("Car", [["Honda", 750000, 1], ["Camry", 10000000, 1], ["Corolla", 75000000, 1], ["BMW", 25000000, 1]]);
products.set("Appliances", [["Laptop", 500000, 1], ["Phone", 200000, 1], ["Tablet", 400000, 1], ["iwatch", 68000, 1]]);
...
const displayProducts = (num = 0) => {
    let count = 1;
    if (num < 0 || num > 7) {
        return `Please input a valid Product`
    } else {
